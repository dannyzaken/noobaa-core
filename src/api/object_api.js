...
module.exports = {
    ...
    methods: {
        ...
        create_multipart: {
            ...
            params: {
                type: 'object',
                required: ['obj_id', 'bucket', 'key', 'num'],
                properties: {
                    obj_id: {
                        objectid: true,
                    },
        ...
        list_multiparts: {
            ...
            reply: {
                type: 'object',
                required: ['is_truncated', 'multiparts'],
                properties: {
                    is_truncated: {
                        type: 'boolean',
                    },
                    ...
                    multiparts: {
                        ...
                        items: {
                            type: 'object',
                            required: ['num', 'size', 'etag', 'last_modified'],
                            properties: {
                                num: {
                                    type: 'integer',
                                },
        ...
        dispatch_triggers: {
            ...
            params: {
                type: 'object',
                required: ['bucket', 'obj', 'event_name'],
                properties: {
                    bucket: { $ref: 'common_api#/definitions/bucket_name' },
                    obj: {
                        $ref: '#/definitions/object_info',
        ...
        add_endpoint_report: {
            ...
            params: {
                type: 'object',
                required: ['timestamp', 'group_name', 'hostname'],
                properties: {
                    timestamp: {
                        idate: true,
                    },
        ...
        put_object_legal_hold: {
            ...
            params: {
                type: 'object',
                required: ['key', 'bucket', 'legal_hold'],
                properties: {
                    bucket: { $ref: 'common_api#/definitions/bucket_name' },
                    key: {
                        type: 'string',
    ...
    definitions: {
        object_info: {
            type: 'object',
            required: ['obj_id', 'bucket', 'key', 'size', 'content_type'],
            properties: {
                obj_id: { objectid: true },
                bucket: { $ref: 'common_api#/definitions/bucket_name' },
                key: { type: 'string' },
