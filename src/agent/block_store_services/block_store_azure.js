...
class BlockStoreAzure extends BlockStoreBase {
    ...
    try {
      ...
      return {
        ...
        block_md: this._decode_block_md(
          response.metadata.noobaablockmd || response.metadata.noobaa_block_md,
        ),
      };
    } catch (err) {
      dbg.error(
  ...
  async _read_block_md(block_md) {
    ...
    const store_block_md = this._decode_block_md(
      block_info.metadata.noobaablockmd || block_info.metadata.noobaa_block_md,
    );
  ...
  _delete_blocks(block_ids) {
    ...
    return P.map_with_concurrency(10, block_ids, async block_id => {
      ...
      try {
        ...
        const noobaablockmd =
          info_arg.metadata.noobaablockmd || info_arg.metadata.noobaa_block_md;
        dbg.log1(
