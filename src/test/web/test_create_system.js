...
mocha.describe('create_system', function () {
    ...
    mocha.it('should fill signup form and create system', function () {
        ...
        return d
            ...
            .then(() =>
                d.wait(wd.until.titleIs('NooBaa Management Console'), 2000),
            )
            ...
            .then(() =>
                d.wait(wd.until.elementLocated(wd.By.tagName('input')), 1000),
            )
            ...
            .then(() =>
                d.wait(wd.until.elementIsVisible(self.buttons[1]), 1000),
            )
            .then(() => self.buttons[1].click())
            .then(() =>
                console.log('Wait for input element in second step ...'),
            )
            .then(() => d.wait(wd.until.elementIsVisible(self.inputs[4]), 1000))
            .then(() => console.log('Wait for button to create system ...'))
            .then(() =>
                d.wait(wd.until.elementIsVisible(self.buttons[2]), 1000),
            )
            .then(() => self.inputs[4].sendKeys('demo'))
            .then(() => P.delay(500))
            .then(() => self.buttons[2].click())
            .then(() =>
                console.log('Wait for url to open the created system ...'),
            )
