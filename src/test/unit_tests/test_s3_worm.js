...
mocha.describe('s3 worm', function () {
    ...
    mocha.describe('bucket object lock configuration on BKT', function () {
        ...
        mocha.it(
            'should fail put faulty lock configuration',
            async function () {
                await assert_throws_async(
                    s3_owner
                        .putObjectLockConfiguration({
            ...
            const conf = await s3_owner
                .putObjectLockConfiguration({
                    ...
                    ObjectLockConfiguration: {
                        ObjectLockEnabled: 'Enabled',
                        Rule: {
                            DefaultRetention: { Days: 15, Mode: 'COMPLIANCE' },
                        },
                    },
                })
                .promise();
    ...
    mocha.describe('OBJ1 checks', function () {
        ...
        mocha.it(
            'fail delete object with retention COMPLIANCE',
            async function () {
                await assert_throws_async(
                    s3_owner
                        .deleteObject({
    ...
    mocha.describe(
        ...
        function () {
            ...
            mocha.it(
                'should list objects in BKT contains OBJ3',
                async function () {
                    const res = await s3_owner
                        .listObjects({ Bucket: BKT })
                        .promise();
