  ...
  mocha.it('issue use case', function () {
    ...
    return run_case(
      ...
      async function (server_upload_response) {
        ...
        assert.strictEqual(
          _.difference(expected_files_uploaded, list_reply.common_prefixes)
            .length,
          0,
  ...
  mocha.it('general use case', function () {
    ...
    return run_case(
      ...
      async function (server_upload_response) {
        ...
        assert.strictEqual(
          _.difference(folders_to_upload, list_reply.common_prefixes).length,
          0,
          'prefixes: ' + list_reply.common_prefixes,
        );
        assert.strictEqual(
        ...
        assert.strictEqual(
          _.difference(files_without_folders_to_upload, objects).length,
          0,
          'objects: ' + objects,
        );
  ...
  mocha.it('multipart uploads id-marker', function () {
    ...
    return run_case(
      ...
      async function (server_upload_response) {
        ...
        assert.strictEqual(
          _.difference([server_upload_response[0].key], objects).length,
          0,
          'objects:' + objects,
        );
        assert(is_sorted_array(objects), 'objcets not sorted' + objects);
  ...
  mocha.it('multipart uploads id-marker breakage test', function () {
    ...
    return run_case(
      ...
      async function (server_upload_response) {
        ...
        assert.strictEqual(
          _.difference(['multipart2/'], list_reply.common_prefixes).length,
          0,
          'prefixes: ' + list_reply.common_prefixes,
        );
        assert.strictEqual(
  ...
  mocha.it('prefix with delimiter infinite infinite loop listing', function () {
    ...
    return run_case(
      ...
      async function (server_upload_response) {
        ...
        const objects = _.map(list_reply.objects, obj => obj.key);
        assert.strictEqual(
          _.difference(['d/d/'], list_reply.common_prefixes).length,
          0,
          'prefixes: ' + list_reply.common_prefixes,
        );
        assert.strictEqual(
