...
mocha.describe('manage_nsfs cli', function () {
    ...
    mocha.describe('cli bucket flow ', async function () {
        ...
        const bucket_policy = generate_s3_policy('*', bucket_with_policy, [
            's3:*',
        ]).policy;
        const bucket1_policy = generate_s3_policy('*', name, ['s3:*']).policy;
        const invalid_bucket_policy = generate_s3_policy(
            'invalid_account',
            name,
            ['s3:*'],
        ).policy;
        ...
        const gpfs_bucket_options = {
            config_root,
            name: bucket_on_gpfs,
            owner,
            path: bucket_on_gpfs_path,
            fs_backend: 'GPFS',
        };
        const bucket_with_policy_options = {
            ...bucket_options,
        ...
        mocha.it(
            'cli bucket create without existing account - should fail',
            async function () {
                ...
                try {
                    ...
                    assert.fail(
                        'should have failed since the bucket owner does not exist',
                    );
                } catch (err) {
                    assert_error(
                        err,
        ...
        mocha.it(
            'cli create account for bucket (bucket create requirement to have a bucket owner)',
            async function () {
                const action = ACTIONS.ADD;
                ...
                await set_path_permissions_and_owner(
                    new_buckets_path1,
                    { uid: account_options1.uid, gid: account_options1.gid },
                    0o700,
                );
                ...
                await set_path_permissions_and_owner(
                    new_buckets_path2,
                    { uid: account_options2.uid, gid: account_options2.gid },
                    0o700,
                );
        ...
        mocha.it(
            "cli bucket create - should fail bucket owner's allow_bucket_creation is false",
            async function () {
                ...
                try {
                    ...
                    await exec_manage_cli(type, action, {
                        ...bucket_options_with_owner_of_account_cannot_create_bucket,
                    });
                    assert.fail(
                        'should have failed with not allowed to create new buckets',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli bucket create with invalid bucket policy - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    await fs_utils.create_fresh_path(bucket_path);
                    ...
                    await exec_manage_cli(type, action, {
                        ...bucket_options,
                        bucket_policy: invalid_bucket_policy,
                    });
                    assert.fail(
                        'should have failed with invalid bucket policy',
                    );
                } catch (err) {
        ...
        mocha.it('cli bucket create - bucket_with_policy', async function () {
            const action = ACTIONS.ADD;
            add_res = await exec_manage_cli(
                type,
                action,
                bucket_with_policy_options,
            );
            ...
            const bucket =
                await config_fs.get_bucket_by_name(bucket_with_policy);
        ...
        mocha.it(
            'cli bucket create - should fail invalid option',
            async function () {
                const action = ACTIONS.ADD;
                const bucket_options_with_invalid_option = {
                    ...bucket_options,
                    lala: 'lala',
                }; // lala invalid option
                try {
                    add_res = await exec_manage_cli(
                        type,
                        action,
                        bucket_options_with_invalid_option,
                    );
        ...
        mocha.it('cli bucket status', async function () {
            ...
            const bucket_status = await exec_manage_cli(type, action, {
                config_root,
                name,
            });
        ...
        mocha.it(
            'cli bucket status - should fail invalid option',
            async function () {
                const action = ACTIONS.STATUS;
                const bucket_options_with_invalid_option = {
                    ...bucket_options,
        ...
        mocha.it(
            'cli bucket status - bucket does not exist - should fail',
            async function () {
                const action = ACTIONS.STATUS;
                try {
                    await exec_manage_cli(type, action, {
                    ...
                    assert.fail(
                        'should have failed with bucket does not exist',
                    );
                } catch (err) {
        ...
        mocha.it('cli bucket list', async function () {
            ...
            const bucket_list = await exec_manage_cli(type, action, {
                config_root,
            });
        ...
        mocha.it(
            'cli bucket list - wide "TRUE" (case insensitive)',
            async function () {
                const action = ACTIONS.LIST;
                const bucket_list = await exec_manage_cli(type, action, {
                    config_root,
        ...
        mocha.it(
            'cli bucket list - wide "FALSE" (case insensitive)',
            async function () {
                const action = ACTIONS.LIST;
                const bucket_list = await exec_manage_cli(type, action, {
                    config_root,
        ...
        mocha.it(
            'cli bucket list - should fail invalid option',
            async function () {
                const action = ACTIONS.LIST;
                const bucket_options_with_invalid_option = {
                    config_root,
        ...
        mocha.it(
            'cli bucket list wide - should fail invalid string value',
            async function () {
                const action = ACTIONS.LIST;
                ...
                try {
                    ...
                    assert.fail(
                        'should have failed with invalid boolean value',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli bucket list wide - should fail invalid type',
            async function () {
                const action = ACTIONS.LIST;
        ...
        mocha.it(
            'cli bucket create - should fail on already exists',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    await exec_manage_cli(type, action, bucket_options);
                    assert.fail(
                        'should have failed with bucket already exists',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli bucket create - should fail on invalid bucket name',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    await exec_manage_cli(type, action, {
        ...
        mocha.it(
            'cli bucket update - should fail on invalid bucket name',
            async function () {
        ...
        mocha.it(
            'cli bucket update - should fail invalid option',
            async function () {
                const action = ACTIONS.UPDATE;
                const bucket_options_with_invalid_option = {
                    config_root,
        ...
        mocha.it('cli bucket update owner', async function () {
            ...
            const update_res = await exec_manage_cli(
                type,
                action,
                update_options,
            );
            ...
            await assert_config_file_permissions(CONFIG_SUBDIRS.BUCKETS, name);
            assert.equal(
                JSON.parse(update_res).response.reply.creation_date,
                JSON.parse(add_res).response.reply.creation_date,
            );
        });

        mocha.it(
            'cli bucket update invalid bucket policy - should fail',
            async function () {
                const action = ACTIONS.UPDATE;
        ...
        mocha.it('cli bucket update bucket policy', async function () {
            ...
            bucket_options = {
                ...bucket_options,
                bucket_policy: bucket1_policy,
            };
            await exec_manage_cli(type, action, bucket_options);
            const bucket = await config_fs.get_bucket_by_name(
                bucket_options.name,
            );
            await assert_bucket(bucket, bucket_options);
            await assert_config_file_permissions(
        ...
        mocha.it(
            'cli bucket update bucket policy - delete bucket policy',
            async function () {
                const action = ACTIONS.UPDATE;
                bucket_options = {
                    ...bucket_options,
                    bucket_policy: empty_bucket_policy,
                };
                await exec_manage_cli(type, action, bucket_options);
        ...
        mocha.it(
            'cli bucket2 update - new_name already exists',
            async function () {
                ...
                try {
                    ...
                    assert.fail(
                        'should have failed with bucket name already exists',
                    );
                } catch (err) {
                    assert_error(err, ManageCLIError.BucketAlreadyExists);
                }
        ...
        mocha.it('cli bucket delete', async function () {
            ...
            try {
                const res = await exec_manage_cli(type, action, {
                    config_root,
                ...
                assert.fail(
                    'cli bucket delete failed - bucket config file exists after deletion',
                );
            } catch (err) {
        ...
        mocha.it(
            'cli bucket delete - should fail invalid option',
            async function () {
                const action = ACTIONS.UPDATE;
                const bucket_options_with_invalid_option = {
                    config_root,
        ...
        mocha.it('cli bucket create on GPFS', async function () {
            ...
            const bucket_status = await exec_manage_cli(
                type,
                action,
                gpfs_bucket_options,
            );
    ...
    mocha.describe('cli account flow', async function () {
        ...
        mocha.it('cli account status', async function () {
            const action = ACTIONS.STATUS;
            const account_status = await exec_manage_cli(type, action, {
                config_root,
            ...
            const access_key_account_status = await exec_manage_cli(
                type,
                action,
                { config_root, access_key: account_options.access_key },
            );
            await assert_response(
                action,
                type,
                access_key_account_status,
                account_options,
            );
            const account_symlink = await config_fs.get_account_by_access_key(
                access_key,
        ...
        mocha.it(
            'cli account status - account does not exist - should fail',
            async function () {
                const action = ACTIONS.STATUS;
                try {
                    await exec_manage_cli(type, action, {
                    ...
                    assert.fail(
                        'should have failed with account does not exist',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli account status show_secrets "TRUE" (case insensitive)',
            async function () {
                const action = ACTIONS.STATUS;
                const account_status = await exec_manage_cli(type, action, {
                    config_root,
        ...
        mocha.it('cli account status show_secrets "false"', async function () {
            ...
            assert.equal(
                JSON.parse(account_status).response.reply.access_keys,
                undefined,
            );
        });

        mocha.it(
            'cli account status show_secrets "FALSE" (case insensitive)',
            async function () {
                const action = ACTIONS.STATUS;
                const account_status = await exec_manage_cli(type, action, {
                    config_root,
        ...
        mocha.it(
            'list wide with invalid string value - should fail',
            async function () {
                const action = ACTIONS.STATUS;
                try {
                    await exec_manage_cli(type, action, {
        ...
        mocha.it(
            'list wide with invalid type - should fail',
            async function () {
                const action = ACTIONS.STATUS;
                try {
                    await exec_manage_cli(type, action, {
        ...
        mocha.it(
            'cli account create - no uid gid - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    const options = {
                        config_root,
                        name: crypto_random_string(7),
                        access_key: crypto_random_string(20),
                        secret_key,
                    };
                    await exec_manage_cli(type, action, options);
                    assert.fail(
                        'should have failed with account config should not be empty',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli account create - no uid - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    const options = {
                    ...
                    await exec_manage_cli(type, action, options);
                    assert.fail(
                        'should have failed with account config should include UID',
                    );
                } catch (err) {
                    assert_error(
                        err,
                        ManageCLIError.MissingAccountNSFSConfigUID,
                    );
                }
            },
        );
        ...
        mocha.it(
            'cli account create - no gid - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    const options = {
                    ...
                    await exec_manage_cli(type, action, options);
                    assert.fail(
                        'should have failed with account config should include GID',
                    );
                } catch (err) {
                    assert_error(
                        err,
                        ManageCLIError.MissingAccountNSFSConfigGID,
                    );
                }
            },
        );
        ...
        mocha.it(
            'cli account create - new_buckets_path does not exist - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    const options = {
                        ...
                        name: crypto_random_string(7),
                        access_key: crypto_random_string(20),
                        new_buckets_path: 'path_does/not_exist',
                    };
                    await exec_manage_cli(type, action, options);
                    assert.fail(
                        'should have failed with new_buckets_path should be a valid dir path',
                    );
                } catch (err) {
                    assert_error(
                        err,
                        ManageCLIError.InvalidAccountNewBucketsPath,
                    );
                }
            },
        );
        ...
        mocha.it(
            'cli account create - name exists - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    await exec_manage_cli(type, action, {
                        ...account_options,
                        access_key: 'GIGiFAnjaaE7OKrandom',
                    });
                    assert.fail(
                        'should have failed with account name already exists',
                    );
                } catch (err) {
        ...
        mocha.it(
            'cli account create - access_key exists - should fail',
            async function () {
                const action = ACTIONS.ADD;
                try {
                    await exec_manage_cli(type, action, {
                    ...
                    assert.fail(
                        'should have failed with account access key already exists',
                    );
                } catch (err) {
                    assert_error(
                        err,
                        ManageCLIError.AccountAccessKeyAlreadyExists,
                    );
                }
            },
        );
        ...
        mocha.it('cli account list', async function () {
            const action = ACTIONS.LIST;
            const account_list = await exec_manage_cli(type, action, {
                config_root,
            });
        ...
        mocha.it('cli account update uid by name', async function () {
            ...
            await set_path_permissions_and_owner(
                update_options.new_buckets_path,
                update_options,
                0o700,
            );
            const update_response = await exec_manage_cli(
                type,
                action,
                update_options,
            );
            ...
            assert_account(account, account_options);
            assert.equal(
                JSON.parse(update_response).response.reply.creation_date,
                JSON.parse(add_res).response.reply.creation_date,
            );
        });
        ...
        mocha.it('cli account delete by name', async function () {
            ...
            try {
                ...
                throw new Error(
                    'cli account delete failed - account config link file exists after deletion',
                );
            } catch (err) {
                if (err.code !== 'ENOENT') {
                    throw new Error(
                        'cli account delete failed - read file failed with the following error - ',
                        err.code,
                    );
                }
            }
            try {
                await config_fs.get_account_by_name(
                    account_options.name,
                    config_fs_account_options,
                );
                throw new Error(
                    'cli account delete failed - account config file exists after deletion',
                );
            } catch (err) {
                if (err.code !== 'ENOENT') {
                    throw new Error(
        ...
        mocha.it('cli account create on GPFS', async function () {
            const action = ACTIONS.ADD;
            const account_status = await exec_manage_cli(
                type,
                action,
    ...
    mocha.describe('cli account flow - updates', async function () {
        ...
        const account2_options = {
            ...
            uid,
            gid,
            access_key: 'BISiDSnjaaE7OKD5N7hB',
            secret_key,
        };
        ...
        mocha.it(
            'cli account2 update - new_name already exists',
            async function () {
                const action = ACTIONS.UPDATE;
                try {
                    await exec_manage_cli(type, action, {
        ...
        mocha.it(
            'cli account2 update - new_access_key already exists',
            async function () {
                const action = ACTIONS.UPDATE;
    ...
    mocha.describe(
        'cli account flow distinguished_name - happy path',
        async function () {
            this.timeout(50000); // eslint-disable-line no-invalid-this
            const type = TYPES.ACCOUNT;
            const name = 'account2';
            ...
            mocha.it(
                'cli account update distinguished_name',
                async function () {
                    const action = ACTIONS.UPDATE;
                    const update_options = {
                        config_root,
    ...
    mocha.describe('cli whitelist flow', async function () {
        ...
        mocha.it(
            'cli add whitelist ips first time (IPV4 format)',
            async function () {
        ...
        mocha.it(
            'cli update whitelist ips (IPV6 expanded format)',
            async function () {
        ...
        mocha.it(
            'cli update whitelist ips (IPV6 compressed format)',
            async function () {
        ...
        mocha.it('cli whitelist ips is empty', async function () {
            try {
                ...
                assert.fail(
                    'should have failed with whitelist ips should not be empty.',
                );
            } catch (err) {
        ...
        mocha.it('cli whitelist formate is invalid', async function () {
            try {
                ...
                await exec_manage_cli(type, '', {
                    config_root,
                    ips: ip_list_invalid_format,
                });
                assert.fail(
                    'should have failed with whitelist ips with invalid body format',
                );
            } catch (err) {
                assert_error(err, ManageCLIError.InvalidWhiteListIPFormat);
            }
        ...
        mocha.it(
            'cli whitelist has invalid IP address (one item in the list)',
            async function () {
                const ip_list_with_invalid_ip_address = ['10.1.11']; // missing a class in the IP address
                try {
                    await exec_manage_cli(type, '', {
                        config_root,
                        ips: ip_list_with_invalid_ip_address,
                    });
                    assert.fail(
                        'should have failed with whitelist ips with invalid ip address',
                    );
                } catch (err) {
                    assert_error(err, ManageCLIError.InvalidWhiteListIPFormat);
                }
        ...
        mocha.it(
            'cli whitelist has invalid IP address (a couple of items in the list)',
            async function () {
...
async function assert_config_file_permissions(
    schema_dir,
    config_file_name,
    is_symlink,
) {
    const config_path = path.join(
        config_root,
        schema_dir,
        config_file_name + (is_symlink ? SYMLINK_SUFFIX : JSON_SUFFIX),
    );
    const { stat } = await nb_native().fs.readFile(
        DEFAULT_FS_CONFIG,
        config_path,
    );
...
async function assert_response(
    action,
    type,
    actual_res,
    expected_res,
    ...
    if (type === TYPES.IP_WHITELIST) {
        assert.equal(
            ...
            ManageCLIResponse.WhiteListIPUpdated.code,
        );
        ...
        if (
            ...
            assert.equal(
                parsed.response.code,
                ManageCLIResponse.BucketDeleted.code,
            );
            ...
            for (let i = 0; i < parsed.response.reply.length; i++) {
                ...
                const expected_res_by_name = expected_res.find(
                    expected => expected.name === name,
                );
                if (wide) {
                    await assert_bucket(
                        parsed.response.reply[i],
                        expected_res_by_name,
                    );
                } else {
                    assert.deepEqual(
                        parsed.response.reply[i],
...
async function assert_bucket(
    bucket,
    bucket_options,
    check_bucket_owner_response,
) {
...
function assert_account(account, account_options, skip_secrets) {
    ...
    assert.equal(
        account.nsfs_account_config.fs_backend,
        account_options.fs_backend === '' ?
            undefined
        :   account_options.fs_backend,
    );
    return true;
...
function assert_whitelist(config_data, config_options) {
    assert.strictEqual(
        config_data.ENDPOINT_FORKS,
        config_options.ENDPOINT_FORKS,
    );
    assert.strictEqual(
        config_data.UV_THREADPOOL_SIZE,
        config_options.UV_THREADPOOL_SIZE,
    );
    assert.strictEqual(
        config_data.S3_SERVER_IP_WHITELIST.length,
        config_options.S3_SERVER_IP_WHITELIST.length,
    );
    return true;
}
