...
exports.empty_filter_marker_lifecycle_configuration =
    empty_filter_marker_lifecycle_configuration;
...
exports.date_lifecycle_configuration_and_tags =
    date_lifecycle_configuration_and_tags;
...
function size_less_days_lifecycle_configuration(
    Bucket,
    ObjectSizeLessThan,
    Days,
) {
...
exports.size_less_days_lifecycle_configuration =
    size_less_days_lifecycle_configuration;
...
function and_tags_prefix_lifecycle_configuration(
    Bucket,
    Key,
    Key1,
    Value1,
...
async function put_get_lifecycle_configuration(Bucket, putLifecycleParams, s3) {
    const putLifecycleResult =
        await s3.putBucketLifecycleConfiguration(putLifecycleParams);
    console.log(
        'put lifecycle params:',
        putLifecycleParams,
        'result',
        putLifecycleResult,
    );
    ...
    const getLifecycleResult =
        await s3.getBucketLifecycleConfiguration(lifecycleParams);
    console.log(
        'get lifecycle params:',
        lifecycleParams,
        'result',
        getLifecycleResult,
    );
    ...
    const deleteLifecycleResult =
        await s3.deleteBucketLifecycle(lifecycleParams);
    console.log(
        'delete lifecycle params:',
        lifecycleParams,
        'result',
...
exports.test_rules_length = async function (Bucket, Key, s3) {
    const putLifecycleParams = rules_length_lifecycle_configuration(
        Bucket,
        Key,
    );
    const getLifecycleResult = await put_get_lifecycle_configuration(
        Bucket,
        putLifecycleParams,
        s3,
    );
    ...
    const expectedRulesLength =
        putLifecycleParams.LifecycleConfiguration.Rules.length;
    console.log(
        'get lifecycle rules length:',
        actualRulesLength,
        ' expected:',
        expectedRulesLength,
    );
    ...
    assert(
        getLifecycleResult.Rules.length ===
            putLifecycleParams.LifecycleConfiguration.Rules.length,
        'number of rules',
    );
};
...
exports.test_expiration_marker = async function (Bucket, Key, s3) {
    ...
    const actualMarker =
        getLifecycleResult.Rules[0].Expiration.ExpiredObjectDeleteMarker;
    const expectedMarker =
        putLifecycleParams.LifecycleConfiguration.Rules[0].Expiration
            .ExpiredObjectDeleteMarker;
    console.log(
        'get lifecycle expiration marker:',
        actualMarker,
        ' expected:',
        expectedMarker,
    );
...
exports.test_expiration_date = async function (Bucket, Key, s3) {
    ...
    const expectedDate = new Date(
        putLifecycleParams.LifecycleConfiguration.Rules[0].Expiration.Date,
    );
    console.log(
        'get lifecycle expiration date:',
        actualDate,
        '(',
        actualDate.getTime(),
        ') expected:',
...
exports.test_rule_status = async function (Bucket, Key, s3) {
    ...
    const expectedStatus =
        putLifecycleParams.LifecycleConfiguration.Rules[0].Status;
    console.log(
...
exports.test_rule_filter = async function (Bucket, Key, s3) {
    ...
    const expectedFilter =
        putLifecycleParams.LifecycleConfiguration.Rules[0].Filter;
...
exports.test_expiration_days = async function (Bucket, Key, s3) {
    ...
    const expectedDays =
        putLifecycleParams.LifecycleConfiguration.Rules[0].Expiration.Days;
    console.log(
        'get lifecycle expiration days:',
        actualDays,
        ' expected:',
        expectedDays,
    );
...
exports.test_filter_tag = async function (Bucket, Key, Value, s3) {
    ...
    const expectedTag =
        putLifecycleParams.LifecycleConfiguration.Rules[0].Filter.Tag;
...
exports.test_and_tag = async function (Bucket, Key1, Value1, Key2, Value2, s3) {
    const putLifecycleParams = and_tags_lifecycle_configuration(
        Bucket,
        Key1,
        Value1,
        Key2,
...
exports.test_and_tag_prefix = async function (
    ...
    const putLifecycleParams = and_tags_prefix_lifecycle_configuration(
        Bucket,
        Key,
        Key1,
        Value1,
...
exports.test_and_prefix_size = async function (Bucket, Key, s3) {
    const putLifecycleParams = and_prefix_size_lifecycle_configuration(
        Bucket,
        Key,
    );
    const getLifecycleResult = await put_get_lifecycle_configuration(
    ...
    assert(
        actualFilter.Tags === expectedFilter.Tags,
        'and prefix size filter - Tags',
    );
    assert(
        actualFilter.Prefix === expectedFilter.Prefix,
        'and prefix size filter - Prefix',
    );
    assert(
        actualFilter.ObjectSizeGreaterThan ===
            expectedFilter.ObjectSizeGreaterThan,
        'and prefix size filter - ObjectSizeGreaterThan',
    );
    assert(
        actualFilter.ObjectSizeLessThan === expectedFilter.ObjectSizeLessThan,
        'and prefix size filter - ObjectSizeLessThan',
    );
};
