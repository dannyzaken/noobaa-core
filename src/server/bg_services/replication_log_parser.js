...
async function get_log_candidates(
  ...
  const endpoint_type =
    source_bucket.namespace.write_resource.resource.connection.endpoint_type;
...
async function get_aws_log_candidates(
  ...
  let log_object_continuation_token =
    _get_log_object_continuation_token_for_rule(rule_id, replication_config);
...
async function get_azure_log_candidates(
  ...
  const prefix =
    replication_config.log_replication_info.azure_log_replication_info.prefix ||
    '';
