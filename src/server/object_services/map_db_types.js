...
class ChunkDB {
    ...
    get _id() {
        return this.chunk_db._id;
    }
    get bucket_id() {
        return this.chunk_db.bucket;
    }
    get tier_id() {
        return this.chunk_db.tier;
    }
    get master_key_id() {
        return this.chunk_db.master_key_id;
    }
    get size() {
        return this.chunk_db.size;
    }
    get compress_size() {
        return this.chunk_db.compress_size;
    }
    get frag_size() {
        return this.chunk_db.frag_size;
    }
    get digest_b64() {
        return to_b64(this.chunk_db.digest);
    }
    get cipher_key_b64() {
        return to_b64(this.chunk_db.cipher_key);
    }
    get cipher_iv_b64() {
        return to_b64(this.chunk_db.cipher_iv);
    }
    get cipher_auth_tag_b64() {
        return to_b64(this.chunk_db.cipher_auth_tag);
    }
    get chunk_coder_config() {
        return this.chunk_config.chunk_coder_config;
    }
    get storage_class() {
    ...
    /** @returns {nb.Bucket} */
    get bucket() {
        return system_store.data.get_by_id(this.chunk_db.bucket);
    }
    /** @returns {nb.Tier} */
    get tier() {
        return system_store.data.get_by_id(this.chunk_db.tier);
    }
    /** @returns {nb.ChunkConfig} */
    get chunk_config() {
        return system_store.data.get_by_id(this.chunk_db.chunk_config);
    }

    /** @returns {FragDB[]} */
    get frags() {
        if (!this.__frags) {
            this.__frags = this.chunk_db.frags.map(frag_db =>
                new_frag_db(frag_db, this),
            );
        }
        return this.__frags;
    }
    ...
    get parts() {
        if (!this.__parts) {
            this.__parts =
                this.chunk_db.parts ? this.chunk_db.parts.map(new_part_db) : [];
        }
        return this.__parts;
    }
    ...
    set_new_chunk_id() {
        throw new Error(
            `ChunkDB.set_new_chunk_id: unexpected call for existing chunk ${this._id}`,
        );
    }
    ...
    _decrypt_cipher_key(cipher_key, master_key_id) {
        ...
        return system_store.master_key_manager.decrypt_value_with_master_key_id(
            cipher_key,
            master_key_id,
        );
    }
    ...
    to_api(adminfo) {
        return {
            ...
            cipher_key_b64: to_b64(
                this._decrypt_cipher_key(
                    this.cipher_key_b64,
                    this.chunk_db.master_key_id,
                ),
            ),
...
class FragDB {
    ...
    get _id() {
        return this.frag_db._id;
    }
    get data_index() {
        return this.frag_db.data_index;
    }
    get parity_index() {
        return this.frag_db.parity_index;
    }
    get lrc_index() {
        return this.frag_db.lrc_index;
    }
    get digest_b64() {
        return to_b64(this.frag_db.digest);
    }
    get frag_index() {
        if (this.frag_db.data_index >= 0) return `D${this.frag_db.data_index}`;
        if (this.frag_db.parity_index >= 0) {
            return `P${this.frag_db.parity_index}`;
        }
    ...
    get blocks() {
        if (!this.__blocks) {
            this.__blocks =
                this.frag_db.blocks ?
                    this.frag_db.blocks.map(block_db =>
    ...
    set_new_frag_id() {
        throw new Error(
            `FragDB.set_new_frag_id: unexpected call for existing frag ${this._id}`,
        );
    }
...
class BlockDB {
    ...
    get _id() {
        return this.block_db._id;
    }
    get node_id() {
        return this.block_db.node;
    }
    get pool_id() {
        return this.block_db.pool;
    }
    get chunk_id() {
        return this.block_db.chunk;
    }
    get frag_id() {
        return this.block_db.frag;
    }
    get bucket_id() {
        return this.block_db.bucket;
    }
    get size() {
        return this.block_db.size;
    }
    get address() {
        return this.node && this.node.rpc_address;
    }

    /** @returns {nb.Pool} */
    get pool() {
        return system_store.data.get_by_id(this.pool_id);
    }
    /** @returns {nb.Bucket} */
    get bucket() {
        return system_store.data.get_by_id(this.bucket_id);
    }
    /** @returns {nb.System} */
    get system() {
    ...
    to_block_md() {
        return {
            ...
            digest_type:
                this.digest_type ||
                this.chunk.chunk_coder_config.frag_digest_type,
        ...
        if (adminfo) {
            ...
            for (const { tier, disabled } of this.bucket.tiering.tiers) {
                ...
                for (const mirror of tier.mirrors) {
                    if (
                        mirror.spread_pools.find(
                            pool => optional_id_str(pool._id) === pool_id_str,
                        )
                    ) {
...
class PartDB {
    ...
    get _id() {
        return this.part_db._id;
    }
    get obj_id() {
        return this.part_db.obj;
    }
    get chunk_id() {
        return this.part_db.chunk;
    }
    get multipart_id() {
        return this.part_db.multipart;
    }

    get start() {
        return this.part_db.start;
    }
    get end() {
        return this.part_db.end;
    }
    get seq() {
        return this.part_db.seq;
    }
