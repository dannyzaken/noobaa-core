...
ManageCLIError.InvalidNewNameAccountIdentifier = Object.freeze({
  ...
  message:
    'Account new_name can not be used on add command, please remove the --new_name flag',
  http_code: 400,
});
...
ManageCLIError.InvalidNewAccessKeyIdentifier = Object.freeze({
  ...
  message:
    'Account new_access_key can not be used on add command, please remove the --new_access_key flag',
  http_code: 400,
});
...
ManageCLIError.InvalidNewNameBucketIdentifier = Object.freeze({
  ...
  message:
    'Bucket new_name can not be used on add command, please remove the --new_name flag',
  http_code: 400,
});
