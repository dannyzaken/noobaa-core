...
async function get_bucket_owner_keys(log_bucket_name) {
    const log_bucket_config_data =
        await config_fs.get_bucket_by_name(log_bucket_name);
    const log_bucket_owner = log_bucket_config_data.owner_account;
    const owner_config_data = await config_fs.get_identity_by_id(
        log_bucket_owner,
