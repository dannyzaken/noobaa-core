...
azure_storage.get_container_client = (blob_service, container) =>
    blob_service.getContainerClient(container);

azure_storage.get_blob_client = (container_client, blob) =>
    container_client.getBlobClient(blob).getBlockBlobClient();

azure_storage.calc_body_md5 = stream_file =>
    crypto_utils.calc_body_md5(stream_file);
...
azure_storage.get_block_id = (block_id_prefix, part_num) =>
    block_id_prefix + '-' + _zeroPaddingString(part_num, 6);
