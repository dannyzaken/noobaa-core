        ...
        return _.filter(instances, function (instance) {
          ...
          if (typeof filter !== 'undefined') {
            if (
              ...
              if (
                instance.tags_map.Name.indexOf(filter.filter_tags) !== -1 ||
    ...
    if (res.State.Name === 'pending') {
      ...
      return ec2_wait_for(res.region_name, 'instanceStatusOk', params)
        ...
        .then(null, function (error) {
          throw new Error(
            'Error in get_ip_address ' + instid + ' on ec2_wait_for ' + error,
          );
        });
          ...
          return P.fcall(function () {
            ...
            return P.ninvoke(s3bucket, 'upload', params).then(
              ...
              function (err2) {
                ...
                if (
                  curr_time.subtract(wait_limit_in_sec, 'second') > start_moment
                ) {
                  console.error(
  ...
  if (is_win) {
    return ec2_region_call(region_name, 'describeImages', {
      Filters: [
        {
          Name: 'name',
          Values: ['Windows_Server-2012-R2_RTM-English-64Bit-Base-2015*'],
        },
      ],
    }).then(function (res) {
      // console.log('res:',res);
